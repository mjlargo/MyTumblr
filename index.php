...
$acc_username="mjlargo";
$acc_password="mjlargo123";
$acc_fullanme="Mark Joseph Largo";
$acc_address="Laylay Boac Marinduque";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
						...
						if(isset($_REQUEST['notexist'])===true){
							...
							echo "<div class='alert alert-warning' role='alert'> You're stile log in. Please
							<a href='account.php'>click here </a> to proceed.</div>";
						}
